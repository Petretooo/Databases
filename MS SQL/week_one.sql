...
VALUES(951231, 'MARIQ', '0886154543', 'PLOVDIV')
...
SET STUDENT_NAME = 'GOSHO'

WHERE STUDENT_NUM = 1254

DELETE

FROM STUDENTS

WHERE STUDENT_NUM = 951231
...
REGION_ID TINYINT FOREIGN KEY REFERENCES REGIONS ON DELETE CASCADE
...
GENDER CHAR(1) CHECK(GENDER IS NULL OR
